      ...
      <div className="hero  pt-24 min-h-screen">
        <div className="hero-content flex-col lg:flex-row-reverse">
          ...
          <div>
            ...
            <button className="btn shadow-2xl rounded-3xl hover:bg-sky-900 text-2xl bg-sky-500 text-white ml-10 p-8 py-8 lg:ml-96 flex justify-center items-center" onClick={() => document.getElementById('my_modal_2').showModal()}>For More Enquiry</button>
